  ...
  return (
    <div className="relative">
      <div className="h-48 sm:h-64 w-full bg-gradient-to-l from-brand-300 to-brand-600 overflow-hidden">
        <img
          src="https://jjvtjuemmkmwkoxfzyng.supabase.co/storage/v1/object/public/imagens-cardapio/cardapioclickprato_bg.png"
          alt="ClickPrato"
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex flex-col sm:flex-row items-center">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-600 mt-1"><b>Pizzarias</b></p>
              <p className="text-gray-600 mt-1"><b>Hamburguerias</b></p>
              <p className="text-gray-600 mt-1"><b>&nbsp;</b></p>
              <p className="text-gray-600 mt-1"><b>Para todo tipo de Restaurante Delivery</b></p>
              <p className="text-gray-600 mt-1"><b>&nbsp;</b></p>              
